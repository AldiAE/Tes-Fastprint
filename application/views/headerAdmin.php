    ...
    <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo base_url('fastprint/BerandaController');?>" class="logo"><i class="ion-ios7-world icon-c-logo"></i><span>Fast Print</span></a>
                        <!-- Image Logo here -->
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="<?php echo base_url('fastprint/BerandaController'); ?>" class="waves-effect"><i class="ti-home"></i>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo base_url('/fastprint/ProdukController'); ?>">Produk</a></li>
                                </ul>
                            </li>
